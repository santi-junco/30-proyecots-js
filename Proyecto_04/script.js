...
const people = [
    ...
    'Berle, Milton', 'Berry, Halle', 'Biko, Steve', 'Beck, Glenn', 'Bergman, Ingmar', 'Black, Elk',
...
// el 0 es para ver el valor de total
const yearsLive = inventors.reduce((total, inventor) => total + (inventor.passed - inventor.year) , 0)
...
// como todos los nombres tiene el formato de 'apellido, nombre' puedo hacer
...
const data = [
    'car', 'car', 'truck', 'truck', 'bike', 'walk', 'car', 'van', 'bike', 'walk', 'car',
